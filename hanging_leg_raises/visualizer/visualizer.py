...
class HangingLegRaisesVisualizer:
    def __init__(self):
    ...
    def _draw_skeleton(self, frame, landmarks, faults, active_side):
        """Draws stick figure for Hanging Leg Raises."""
        h, w = frame.shape[:2]
        ...
        # Draw Joints
        joint_indices = [sh_idx, hip_idx, knee_idx, ank_idx]
        for idx in joint_indices:
            ...
            if lm.visibility > 0.5:
                ...
                if "SWINGING" in faults and idx == hip_idx:
                    color = self.COLORS['RED']
                elif "KNEE_BEND" in faults and idx == knee_idx:
                    color = self.COLORS['RED']
