...
class Normalizer:
    """
    Standardizes landmarks for Tricep Extension analysis.
    1. Origin: Elbow (Primary Pivot) to (0,0).
    2. Facing: Ensures user always faces RIGHT (forearm extends in +X).
    ...
    def process(self, landmarks, calibration_data):
        ...
        # This point remains (mostly) static during strict tricep extensions.
        ...
        for lm in landmarks:
            ...
            # We standardize the pushdown movement to travel towards the RIGHT (+X)
            if active_side == 'LEFT':
                temp_x = -temp_x

            # C. Scale: Standardize by Humerus (Upper Arm) Length
